...
import { WizardQuestion } from '@/features/wizard-gtm/wizard-question';
import { WizardResult } from '@/features/wizard-gtm/wizard-result';
import {
  wizardStages,
  shuffleWizard,
  getDiagnosis,
  type WizardStage,
} from '@/features/wizard-gtm/wizard-utils';

export default function WizardGTMPage() {
